...
const messages = {
  en: {
    ...
    "plan.activity.last7Days": "Last 7d",
    ...
    "plan.activity.workoutCount": "{count}",
    "plan.upcoming.viewRemainingWeeks": "Check Remaining Cycle",
    "history.title": "History",
    "history.volume": "Volume {volume} {unit}",
    "history.lastWorkSetMetric": "{weight}{unit} x {reps}",
    "history.emptyTitle": "No completed workouts yet.",
    "history.emptySubtitle": "Complete your first workout to see it here.",
    "history.filter.all": "All",
    "history.filter.year": "Year",
    ...
    "history.unknownMonth": "No date",
    "history.noRecord": "No record",
    "history.filteredEmptyTitle": "No workouts match these filters.",
    "history.filteredEmptySubtitle": "Try a different year, month, or lift.",
    ...
    "history.estimatedMaxLabel": "e1RM",
    "history.trend.range.month": "M",
    "history.trend.range.year": "Y",
    "history.trend.range.all": "A",
    ...
    "history.lift.change.suffix": " (vs. prev)",
    ...
    "settings.section.info": "Info & Support",
    ...
    "settings.dataBackupHint": "Create a backup file before deleting the app or changing phones. You can restore the data on this device from a saved backup file.",
    "settings.dataExport": "Create Backup File",
    "settings.dataImport": "Import Backup File",
    "settings.dataExporting": "Creating backup...",
    "settings.dataImporting": "Importing backup...",
    "settings.dataExportSuccessTitle": "Backup file ready",
    "settings.dataExportSuccessMessage": "Your backup file is ready to share.",
    "settings.dataExportSavedMessage": "Your backup file was saved in the app. File name: {file}",
    "settings.dataExportFailedTitle": "Could not create backup file",
    "settings.dataImportConfirmTitle": "Import backup file?",
    "settings.dataImportConfirmMessage": "{file}\nCreated {exportedAt}\n\nImporting will replace the data on this device with this backup file.",
    "settings.dataImportConfirmAction": "Import",
    "settings.dataImportSuccessTitle": "Backup restored",
    "settings.dataImportSuccessMessage": "The data on this device now matches the backup file.",
    "settings.dataImportFailedTitle": "Could not import backup file",
    "settings.dataUnknownError": "Something went wrong. Please try again.",
    ...
    "workout.errorWarmupCompleteTitle": "Could not complete warm-up sets",
    "workout.errorWarmupCompleteMessage": "Please try again.",
    "workout.incompleteTitle": "Incomplete Sets",
    "workout.incompleteMessage": "Some sets are not marked as complete. Finish anyway?",
    "workout.exitTitle": "Discard workout?",
    "workout.exitMessage": "All recorded progress for this session will be lost.",
    "workout.stay": "Stay",
    "workout.exit": "Discard",
    ...
    "workout.completeScreen.subtitle": "{lift} is saved.",
    "workout.completeScreen.subtitleFallback": "Your workout is saved.",
    "workout.completeScreen.estimatedPr": "Estimated PR",
    "workout.completeScreen.estimatedOneRepMax": "Estimated 1RM",
    "workout.completeScreen.estimatedPrEmpty": "No estimate",
    "workout.completeScreen.topSet": "Top Set",
    "workout.completeScreen.noTopSet": "No top set",
    "workout.completeScreen.noTopSetDetail": "No completed work set",
    "workout.completeScreen.targetRepsAbove": "+{count} reps over target",
    "workout.completeScreen.targetRepsBelow": "{count} reps under target",
    "workout.completeScreen.targetRepsMet": "Target met",
    "workout.completeScreen.prImproved": "{value} PR",
    "workout.completeScreen.noPr": "No PR",
    "workout.completeScreen.thisCycle": "This Cycle",
    "workout.completeScreen.completedShort": "complete",
    "workout.completeScreen.noCycleProgress": "No cycle progress",
    "workout.completeScreen.noNextWorkout": "No next workout",
    "workout.completeScreen.encouragement": "This was below your previous best, but the session still counts. Keep the record and move to the next prescription.",
    ...
    "session.weekAndSession": "Week {week}",
    "language.en": "English",
    "language.ko": "Korean",
  ...
  ko: {
    ...
    "history.filter.press": "오버헤드프레스",
    "history.logSectionTitle": "운동 기록",
    "history.unknownMonth": "날짜 없음",
    "history.noRecord": "기록 없음",
    "history.filteredEmptyTitle": "선택한 필터에 맞는 기록이 없습니다.",
    "history.filteredEmptySubtitle": "다른 연도, 월, 운동을 선택해 보세요.",
    "history.e1rmTitle": "{lift} 예상 1RM 추이",
    "history.e1rmHelper": "최근 예상 1RM 변화",
    "history.e1rmEmptyTitle": "데이터가 아직 충분하지 않아요",
    "history.e1rmEmptySubtitle": "운동을 더 완료하면 예상 1RM 추이를 볼 수 있어요",
    "history.latestE1rm": "최신 예상 1RM",
    "history.selectedE1rm": "선택 예상 1RM",
    "history.estimatedMaxLabel": "예상 1RM",
    "history.trend.range.month": "월",
    "history.trend.range.year": "연",
    "history.trend.range.all": "전체",
    "history.sessionDate": "운동 날짜",
    "history.allLiftTrendTitle": "리프트별 예상 1RM",
    ...
    "settings.dataBackupHint": "앱을 삭제하거나 휴대폰을 바꾸기 전에 백업 파일을 만들어 두세요. 저장해 둔 백업 파일로 현재 기기 앱의 데이터를 복원할 수 있습니다.",
    "settings.dataExport": "백업 파일 만들기",
    "settings.dataImport": "백업 파일 가져오기",
    "settings.dataExporting": "백업 파일 만드는 중...",
    "settings.dataImporting": "백업 파일 가져오는 중...",
    "settings.dataExportSuccessTitle": "백업 파일 준비됨",
    "settings.dataExportSuccessMessage": "백업 파일을 공유할 수 있게 준비했습니다.",
    "settings.dataExportSavedMessage": "백업 파일을 앱 안에 저장했습니다. 파일 이름: {file}",
    "settings.dataExportFailedTitle": "백업 파일을 만들 수 없습니다",
    "settings.dataImportConfirmTitle": "백업 파일을 가져올까요?",
    "settings.dataImportConfirmMessage": "{file}\n만든 날짜 {exportedAt}\n\n가져오면 현재 기기 앱의 데이터가 이 백업 파일의 내용으로 바뀝니다.",
    "settings.dataImportConfirmAction": "가져오기",
    "settings.dataImportSuccessTitle": "백업 복원 완료",
    "settings.dataImportSuccessMessage": "현재 기기 앱의 데이터를 백업 파일 내용으로 바꿨습니다.",
    "settings.dataImportFailedTitle": "백업 파일을 가져올 수 없습니다",
    "settings.dataUnknownError": "문제가 발생했습니다. 다시 시도해 주세요.",
    ...
    "workout.errorWarmupCompleteTitle": "웜업 세트를 완료할 수 없습니다",
    "workout.errorWarmupCompleteMessage": "다시 시도해 주세요.",
    "workout.incompleteTitle": "미완료 세트",
    "workout.incompleteMessage": "완료되지 않은 세트가 있습니다. 그래도 끝낼까요?",
    "workout.exitTitle": "운동을 중단할까요?",
    "workout.exitMessage": "지금까지 기록한 모든 진행 상황이 초기화됩니다.",
    "workout.stay": "계속하기",
    "workout.exit": "중단하기",
    ...
    "workout.warmupCompleteAll": "전체 체크",
    "workout.warmupCompleteAllDone": "완료됨",
    "workout.warmupCompleting": "체크 중...",
    "workout.startWorkout": "운동 시작",
    "workout.starting": "시작 중...",
    "workout.completeWorkout": "운동 완료",
    "workout.saving": "저장 중...",
    "workout.placeholder.maxReps": "최대횟수",
    "workout.progress.current": "현재 운동",
    "workout.setLabel": "{set}세트",
    "workout.currentSet": "현재 세트",
    "workout.table.set": "세트",
    "workout.table.weight": "무게",
    "workout.table.reps": "횟수",
    ...
    "workout.amrapRepsRequiredTitle": "최대반복 횟수를 입력하세요",
    "workout.amrapRepsRequiredMessage": "최대반복 세트는 완료 전에 실제 반복 횟수를 입력해야 합니다.",
    "workout.subtitle": "{week}주차 / {label}",
    "workout.completeScreen.title": "운동 완료",
    "workout.completeScreen.subtitle": "{lift} 세션을 완료했어요.",
    "workout.completeScreen.subtitleFallback": "운동 기록이 저장됐어요.",
    "workout.completeScreen.estimatedPr": "예상 1RM",
    "workout.completeScreen.estimatedOneRepMax": "예상 1RM",
    "workout.completeScreen.estimatedPrEmpty": "기록 없음",
    "workout.completeScreen.topSet": "최고 세트",
    "workout.completeScreen.noTopSet": "기록 없음",
    "workout.completeScreen.noTopSetDetail": "완료한 본 세트가 없어요",
    "workout.completeScreen.targetRepsAbove": "목표 +{count}회",
    "workout.completeScreen.targetRepsBelow": "목표 -{count}회",
    "workout.completeScreen.targetRepsMet": "목표 달성",
    "workout.completeScreen.prImproved": "{value} 1RM 상승",
    "workout.completeScreen.noPr": "상승 없음",
    "workout.completeScreen.thisCycle": "이번 사이클",
    "workout.completeScreen.completedShort": "완료",
    "workout.completeScreen.noCycleProgress": "사이클 진행 없음",
    "workout.completeScreen.noNextWorkout": "다음 운동 없음",
    "workout.completeScreen.encouragement": "오늘은 지난 최고 기록보다 낮지만, 기록을 남긴 것 자체가 다음 예상 1RM의 기준이 됩니다.",
    ...
    "session.weekAndSession": "{week}주차",
    "language.en": "영어",
    "language.ko": "한국어",
    "weekday.mon.short": "월",
    "weekday.tue.short": "화",
...
export function getWeekTitleLabel(weekIndex: number): string {
  if (weekIndex === 3) return t("week.deload");
  return t("week.title", { week: weekIndex + 1 });
}
