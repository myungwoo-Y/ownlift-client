...
const messages = {
  en: {
    ...
    "history.lastWorkSetMetric": "{weight}{unit} {reps}reps",
  ...
  ko: {
    ...
    "history.e1rmTitle": "{lift} 예상PR 추이",
    "history.e1rmHelper": "최근 예상PR 변화",
    "history.e1rmEmptyTitle": "데이터가 아직 충분하지 않아요",
    "history.e1rmEmptySubtitle": "운동을 더 완료하면 예상PR 추이를 볼 수 있어요",
    "history.latestE1rm": "최신 예상PR",
    "history.selectedE1rm": "선택 예상PR",
    "history.estimatedMaxLabel": "예상PR",
    "history.sessionDate": "운동 날짜",
    "history.allLiftTrendTitle": "리프트별 예상PR",
    ...
    "workout.completeScreen.estimatedPr": "예상PR",
    "workout.completeScreen.estimatedOneRepMax": "예상PR",
    ...
    "workout.completeScreen.prImproved": "{value} PR",
    "workout.completeScreen.noPr": "PR 없음",
    ...
    "workout.completeScreen.encouragement": "오늘은 지난 최고 기록보다 낮지만, 기록을 남긴 것 자체가 다음 PR의 기준이 됩니다.",
