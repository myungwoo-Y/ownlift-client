...
const messages = {
  en: {
    ...
    "history.e1rmHelper": "Estimated 1RM from recent completed sessions",
    ...
    "history.allLiftTrendTitle": "Lift e1RM Trends",
  ...
  ko: {
    ...
    "settings.upperBodyHint": "오버헤드 프레스, 벤치 프레스",
